...
rag_retrieval_tool = VertexAiRagRetrieval(
    ...
    description=(
        'Search case study documents to find client stories, results, mechanisms, and services rendered. '
        'Use this tool to access detailed case study information for analysis and extraction.'
    ),
    rag_resources=[
        rag.RagResource(
