...
source: "website"
content_type: "other"
url: "https://parlant.io/docs/api/legacy-create-guidelines"
title: "/docs/api/legacy-create-guidelines"
domain: "parlant.io"
path: "/docs/api/legacy-create-guidelines"
scraped_time: "2025-09-08T19:58:33.769271"
url_depth: 3
word_count: 576
---

Create Guidelines | Parlant
...
Invoices are obtained by calling the `create_evaluation` method of the client. (Equivalent to making a POST request to `/index/evaluations`) See the [documentation](https://parlant.io/docs/concepts/customization/guidelines) for more information.
...
](/docs/api/legacy-create-evaluation)[

Next

Create Term

](/docs/api/legacy-create-term)
