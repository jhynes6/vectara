...
source: "website"
content_type: "other"
url: "https://parlant.io/docs/api/list-events"
title: "/docs/api/list-events"
domain: "parlant.io"
path: "/docs/api/list-events"
scraped_time: "2025-09-08T19:59:55.143268"
url_depth: 3
word_count: 617
---
...
*   When wait\_for\_data = 0: Returns immediately with any existing events that match the criteria
*   When wait\_for\_data > 0:
...
](/docs/api/list-customers)[

Next

List Guidelines

](/docs/api/list-guidelines)
