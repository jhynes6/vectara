...
source: "website"
content_type: "other"
url: "https://parlant.io/docs/api/create-session"
title: "/docs/api/create-session"
domain: "parlant.io"
path: "/docs/api/create-session"
scraped_time: "2025-09-08T19:59:33.058782"
url_depth: 3
word_count: 525
---

Create Session | Parlant
...
The session will be initialized with the specified agent and optional customer. If no customer\_id is provided, a guest customer will be created.
