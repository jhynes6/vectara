...
source: "website"
content_type: "other"
url: "https://parlant.io/docs/api/delete-value"
title: "/docs/api/delete-value"
domain: "parlant.io"
path: "/docs/api/delete-value"
scraped_time: "2025-09-08T19:59:02.730072"
url_depth: 3
word_count: 537
---

Delete Value | Parlant
...
The key should be a customer identifier or a customer tag in the format `tag:{tag_id}`. Removes only the value for the specified key while keeping the variable's configuration.
...
](/docs/api/delete-utterance)[

Next

Delete Variable

](/docs/api/delete-variable)
